    ...
    <div>
      <div id="Book-A-Car">
        <div className="heading">
          <span style={{ color: "#121212" }}>HOW IT WORKS</span>
        ...
        <div className="ride-container">
          <div className="box items-center">
            ...
            <h2 style={{ color: "#121212" }}>Choose A Location</h2>
            <p>
          ...
          <div class="box">
            ...
            <h2 style={{ color: "#121212" }}>Pick-Up Date</h2>
            <p>
          ...
          <div class="box">
            ...
            <h2 style={{ color: "#121212" }}>Book A Car</h2>
            <p>
          ...
          <div class="box">
            ...
            <h2 style={{ color: "#121212" }}>Verify Your Documents</h2>
            <p>
