...
const About = () => {
  ...
  return (
    <div>
      <div id="About-Us" className="aboutpadding">
        {!isScreenSmall ? (
          <div className="heading ">
            <span className="text-[#121212]" id="aboutUsId">
              About Us
            </span>
            <h1>Experience Coolness in Motion</h1>
          </div>
        ) : (
          <div className="heading text-xl text-[#121212] font-semibold">
            About Us Experience Coolness in Motion
          </div>
        )}
        ...
        <div className="about-container">
          <div className="box">
            ...
            <h2 style={{ color: "#121212" }}>Customer-Centric Focus</h2>
            <p>
          ...
          <div className="box">
            ...
            <h2 style={{ color: "#121212" }}>Innovation And Technology</h2>
            <p>
          ...
          <div className="box">
            ...
            <h2 style={{ color: "#121212" }}>Eco-Friendly Initiative</h2>
            <p>
          ...
          <div className="box">
            ...
            <h2 style={{ color: "#121212" }}>Global Reach, Local Touch</h2>
            <p>
          ...
          <div className="box">
            ...
            <h2 style={{ color: "#121212" }}> Your Travel Companion</h2>
            <p>
